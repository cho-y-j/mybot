    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-[var(--foreground)]">사이트 관리자</h1>
          <p className="mt-1 text-sm text-[var(--muted)]">
            <span className="font-mono text-[var(--muted)]">{code}</span> 사이트 로그인
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-[var(--background)] px-4 py-3 text-sm text-[var(--foreground)] outline-none transition-colors focus:border-accent/50 focus:ring-1 focus:ring-accent/50"
              placeholder="••••••••"
              required
            />
          </div>
