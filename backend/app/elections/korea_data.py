...
ELECTION_ISSUES = {
    ...
    "mayor": {
        ...
        "issues": [
            # 도시개발·주거
            "도시개발","재개발","재건축","신도시","택지개발","도시재생",
            "아파트","공공임대","주거환경","집값","전세","청년주거",
            # 교통·도로
            "교통","대중교통","도로","BRT","버스노선","주차","주차장",
            "자전거도로","보행로","교통체증","도로확장",
            # 경제·일자리
            "일자리","기업유치","산업단지","창업","소상공인","자영업",
            "전통시장","상권","골목상권","청년일자리","여성일자리",
            "지역경제","투자유치","스타트업","사회적경제",
            # 복지·보육
            "복지","노인복지","아동복지","장애인복지","기초생활",
            "어린이집","보육","돌봄","방과후","초등돌봄",
            "급식","무상급식","출산","저출생","인구감소",
            # 의료·건강
            "병원","응급의료","보건소","공공의료",
    ...
    "gun_head": {
        "label": "군수 (기초단체장)",
        "issues": [
            "농업","농촌소멸","인구유출","귀농귀촌","축산",
            "복지","노인복지","아동복지","교통","오지교통",
            "산림","환경","상수도","폐기물",
            "기업유치","일자리","관광","전통시장",
            "보건소","응급의료","돌봄","교육환경",
        ],
    ...
    "gu_head": {
        "label": "구청장 (자치구·기초단체장)",
        "issues": [
            "재개발","재건축","주차","주거환경","아파트","집값",
            "교통","대중교통","도로","보행로",
            "복지","노인복지","아동복지","돌봄","어린이집",
            "안전","CCTV","범죄예방","스쿨존",
            "공원","녹지","쓰레기","골목상권","전통시장",
        ],
    },
    ...
    "basic_council": {
        "label": "시·군·구의원 (기초의원)",
        "issues": [
            "민원","도로보수","주차","공원","주거환경","생활편의",
            "CCTV","가로등","버스","통학로","스쿨존",
            "전통시장","노인복지","어린이집","경로당","주민센터",
            "예산","조례","의정활동","주민자치",
        ],
    },
    # ── 교육감 ──
    "superintendent": {
        "label": "교육감",
        "issues": [
            "급식", "무상급식", "친환경급식", "돌봄", "늘봄학교", "초등돌봄",
            "학폭", "학교폭력", "왕따", "사이버폭력",
            "교권", "교권보호", "교사처우", "기간제교사", "악성민원",
            "방과후", "방과후학교", "입시", "수능", "기초학력", "학력저하",
            "교육예산", "교육재정", "디지털교육", "AI교육", "코딩교육", "에듀테크",
            "유치원", "유아교육", "어린이집", "누리과정",
            "특수교육", "장애학생", "학교안전", "교육격차", "교육불평등",
            "사교육", "학원", "사교육비", "학급당학생수", "과밀학급",
            "혁신학교", "고교학점제", "자유학기제",
            "학생인권", "정신건강", "위기학생", "심리상담",
            "소규모학교", "학교통폐합", "농촌학교",
            "다문화교육", "대안학교", "학교밖청소년",
