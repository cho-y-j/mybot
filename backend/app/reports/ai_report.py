...
10. 타겟 유권자 대응 — 세그먼트별 대응 전략 (연령대/지역 등)
...
17. 위기 대비 시나리오 — 예상되는 견제와 대응 방안
18. 타겟 대응 전략 — 다음 주 집중할 유권자 세그먼트
19. 불편한 진실 — 이번 주 우리에게 가장 불리했던 데이터 (필수)
20. 전략 조정 권고 — 지난주 대비 전략을 바꿔야 할 부분

각 섹션은 3-5줄. 총 보고서 4000자 이내. 반드시 한국어.
...
async def _build_report_data(
    ...
    # election-shared + soft hide 필터 통일 (list_election_candidates: hidden 후보 자동 제외)
