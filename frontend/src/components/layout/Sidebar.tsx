...
const sections = [
  {
    ...
    items: [
      ...
      { href: '/dashboard/youtube', label: '유튜브', icon: 'M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/elections/keywords', label: '키워드', icon: 'M7 20l4-16m2 16l4-16M6 9h14M4 15h14' },
    ...
    <aside className="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col">
      <div className="flex items-center gap-2 px-5 py-5 border-b border-gray-100">
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-400 leading-none mt-0.5">선거 분석 플랫폼</p>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-gray-100">
        <Link href="/admin" className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors">
