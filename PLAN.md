...
# Phase 7 — 쉬운 모드 UI — 완료 (2026-04-15)

## P7-01. 기초 구조 — 완료
- [x] /easy/layout.tsx (2단계 사이드바)
- [x] 기본 4개 메뉴 + 전문가 펼침 (8개)
- [x] localStorage preferred_mode

## P7-02. Today's Action 홈 — 완료
- [x] services/today_actions.py: 우선순위 액션 추천
  - 위기 (weakness 2건+) / 기회 (opportunity) / 브리핑 / 강점
- [x] GET /api/easy/today/{election_id}
- [x] /easy/page.tsx: 인사+D-day+액션카드+숫자요약+빠른만들기
- [x] 실제 데이터 검증: 김진균 캠프 → 3개 액션 자동 생성 확인

## P7-03. 부동 AI 비서 — 완료
- [x] FloatingAssistant.tsx: 모든 페이지 우하단 부동 버튼
- [x] 챗 마크다운 + 표 렌더링
- [x] 빠른 질문 3개 (오늘 뭐해야 돼? / 경쟁자 공세? / 핵심 이슈?)

## P7-04. 콘텐츠 마법사 — 완료
- [x] 3단계 마법사 (유형 → 주제(AI추천) → 생성)
- [x] AI 추천 주제 자동 로드
- [x] [AI 활용] + 선거법 안내 자동 표시
- [x] 출처 각주 + 다음 액션 버튼

## P7-05. AI 비서 페이지 — 완료
- [x] /easy/assistant 풀스크린
- [x] 9개 예시 질문 카드
- [x] 출처 각주 표시
